...
module.exports = exports = function JsonModule(config) {
  ...
  */
  function findKVJSON(kvpairs, opts, callback) {
    if (typeof opts === 'function') {
     callback = opts;
     opts = {};
    }
 ...
 /*
  * Find JSON documents that match the given properties or query
  *
  * e.g. var login = "dscape";
  *      db.json.find(
  *        { github: login
  ...
  */
  function findJSON(query, opts, callback) {
    if(typeof query === "string") {
      return findQSJSON(query,opts,callback);
    }
    else if(typeof query === "object") {
      return findKVJSON(query,opts,callback);
    }
    else {
      return callback(err.paramsError(e, "INVALID_QUERY"));
    }
  }
